...
![](images/bev_scattered_features_visualization.png)

## This is the mmdetection3d visualization repo, based on original mmdetection3d

![Bird's Eye View Raw Point Clouds](images/bev_points_visualization.png)
![Bird's Eye View Intermediate Features](images/bev_final_features_visualization.png)

### Supported features
- Visualize Bird's eye view of raw point clouds
- Visualize Bird's eye view intermediate features
- Provide in-depth code analysis on
  - [Centerpoint](CenterPoint.md)
  - [BEVFusion](BEVFusion.md)
