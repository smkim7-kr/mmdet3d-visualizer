...
model = dict(
    ...
    data_preprocessor=dict( 
        ...
        bgr_to_rgb=False),
    img_backbone=dict( # Swin transformer to oextract features (pyramid)
    ...
    img_neck=dict( # lift splat shoot to predict depth
    ...
    view_transform=dict( # view transformation
        ...
        dbound=[1.0, 60.0, 0.5], # (60-1)/0.5 = 118 bins depth distribution
        downsample=2),
    fusion_layer=dict( # (camera channel=80, Lidar channel=256)
