...
def parse_args():
    ...
    parser.add_argument('--pcd', 
                        default='data/nuscenes/n015-2018-07-24-11-22-45+0800__LIDAR_TOP__1532402927647951.pcd.bin',
                        help='Point cloud file')
    parser.add_argument('--model', 
                        default='../configs/centerpoint/centerpoint_pillar02_second_secfpn_head-circlenms_8xb4-cyclic-20e_nus-3d.py',
                        help='Config file')
    parser.add_argument('--weights',
                        default='../checkpoint/centerpoint_02pillar_second_secfpn_circlenms_4x8_cyclic_20e_nus_20220811_031844-191a3822.pth',
