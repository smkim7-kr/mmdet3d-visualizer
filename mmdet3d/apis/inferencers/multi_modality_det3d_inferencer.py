    ...
    def _inputs_to_list(self,
        ...
        if isinstance(inputs, dict):
            ...
            #     input['lidar2img'] = lidar2img
                ...
                cam2img = np.asarray([[365.605889726, 0.000000, 258.200805867, 0.000000],
                        [0.000000, 365.605889726, 202.416996729, 0.000000],
                        [0.000000, 0.000000, 1.000000, 0.000000],
                        [0.000000, 0.000000, 0.000000, 1.000000]]
                    )
                # lidar2cam = np.asarray(
                ...
                lidar2cam = np.asarray(
                    [[0.9999239, 0.00983776, -0.00744548, -0.052],
                    [-0.00986829, 0.9999421, -0.00427846, -0.001],
                    [0.00740318, 0.00435161, 0.9999631, -0.002],
                    [0, 0, 0, 1]]
                )
